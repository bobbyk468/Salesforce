...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'Salesforce Administrator', url: '/certifications/administrator' },
...
export default function Adm201StudyGuidePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/adm-201-study-guide" breadcrumbItems={breadcrumbItems} faqItems={faqItems} />
      <CredentialSchema
        certSlug="adm-201"
        certName="Salesforce Administrator"
        description={pageDescription}
        pageUrl="/adm-201-study-guide"
      />
      ...
      <DifficultyHeatmap slug="administrator" />
      {/* Hub CTA */}
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white mt-10">
        ...
        <p className="text-white mb-6">Try the Salesforce Administrator (ADM-201) free practice exam — scored with full explanations.</p>
        <Link
          href="/certifications/administrator"
        ...
        >
          Salesforce Administrator (ADM-201) Free Practice Exam &rarr;
        </Link>
      </div>
    </div>
  )
