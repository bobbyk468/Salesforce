...
export const metadata: Metadata = {
  ...
  canonical: `${siteUrl}/certifications/advanced-administrator`,
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
...
export default function AdvancedAdministratorExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/advanced-administrator-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/advanced-administrator-exam-tips' })
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-500 pt-1">Security + Custom Objects + Automation = 53%. These three sections define the exam. Complex security scenarios are the most common failure point.</p>
        </div>
      </section>
