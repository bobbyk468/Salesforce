...
const pageDescription =
  `Salesforce Advanced Field Service Accredited Professional exam tips for ${RELEASE_CURRENT}: advanced scheduling, resource optimisation, asset management, and scenario strategy to pass.`
...
export default function AdvancedFieldServiceApExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/advanced-field-service-ap-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/advanced-field-service-ap-exam-tips' })
