...
export default function AdvancedFieldServiceApExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <CredentialSchema
        certSlug="advanced-field-service-ap"
        certName="Advanced Field Service AP"
        description={pageDescription}
        pageUrl="/advanced-field-service-ap-exam-tips"
      />
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">At a Glance: What Advanced Field Service AP Covers</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">AP format: 40 questions, 60 minutes, Pass/Fail, $150. The Optimisation Engine and Scheduling Policies are the core differentiators of this advanced certification.</p>
        </div>
      </section>
