...
export default function AgentforceSpecialistVsAiAssociatePage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/agentforce-specialist-vs-ai-associate', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/agentforce-specialist-vs-ai-associate' })
          ...
          <table className="w-full text-sm text-left border-collapse">
            <thead>
              <tr className="border-b-2 border-gray-200">
                ...
                <th className="py-2.5 pr-4 font-semibold text-salesforce-blue">AI Associate</th>
                <th className="py-2.5 font-semibold text-emerald-700">Agentforce Specialist</th>
              </tr>
            </thead>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="rounded-lg border border-salesforce-blue/20 bg-salesforce-blue/5 p-4">
            <p className="text-sm font-semibold text-salesforce-blue mb-2">Take AI Associate First If:</p>
