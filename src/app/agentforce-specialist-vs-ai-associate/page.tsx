...
export default function AgentforceSpecialistVsAiAssociatePage() {
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/agentforce-specialist-vs-ai-associate" breadcrumbItems={breadcrumbItems} faqItems={faqItems} aboutEntities={['/certifications/agentforce-specialist', '/certifications/ai-associate']} />
