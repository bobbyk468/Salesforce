...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'AI Associate', url: '/certifications/ai-associate' },
...
export default function AIAssociateExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/ai-associate-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/ai-associate-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="ai-associate-study-guide" certName="AI Associate" />
      <ExamPricingCard
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">AI Fundamentals + Einstein Features + Responsible AI = 80%. This is primarily a knowledge-based exam — study all three areas equally.</p>
        </div>
      </section>
