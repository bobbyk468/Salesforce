  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <CredentialSchema
        ...
        description={pageDescription}
        pageUrl="/ai-associate-study-guide"
      />
      ...
      <DifficultyHeatmap slug="ai-associate" />
      {/* Hub CTA */}
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white mt-10">
        ...
        <p className="text-white mb-6">Try the AI Associate free practice exam — scored with full explanations.</p>
        <Link
        ...
        >
          AI Associate Free Practice Exam &rarr;
        </Link>
      </div>
    </div>
  )
