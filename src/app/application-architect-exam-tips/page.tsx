...
export default function ApplicationArchitectExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/application-architect-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/application-architect-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="application-architect-study-guide" certName="Application Architect" />
      <ExamPricingCard
