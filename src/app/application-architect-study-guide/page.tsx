...
const pageDescription = `Complete study guide for the Salesforce Certified Application Architect credential: the 4 required domain exams, key topics, recommended study order, and preparation strategy.`
...
export default function ApplicationArchitectStudyGuidePage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/application-architect-study-guide', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/application-architect-study-guide' })
