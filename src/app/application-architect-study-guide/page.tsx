...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'Application Architect', url: '/certifications/application-architect' },
...
export default function ApplicationArchitectStudyGuidePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <CredentialSchema
        certSlug="application-architect"
        certName="Application Architect"
        description={pageDescription}
        pageUrl="/application-architect-study-guide"
      />
      ...
      <ContentPageAuthor />
      <ExamTipsCrossLink examTipsSlug="application-architect-exam-tips" certName="Application Architect" />
      <CertInsightBlock certSlug="application-architect" />
      <ExamPricingCard
        certSlug="application-architect"
        certName="Application Architect"
        certPageSlug="application-architect"
      />
      ...
      <DifficultyHeatmap slug="application-architect" />
      {/* Hub CTA */}
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white mt-10">
        ...
        <p className="text-white mb-6">Try the Application Architect free practice exam — scored with full explanations.</p>
        <Link
        ...
        >
          Application Architect Free Practice Exam &rarr;
        </Link>
      </div>
    </div>
  )
