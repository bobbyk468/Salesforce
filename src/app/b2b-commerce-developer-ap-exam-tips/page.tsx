...
const pageDescription =
  `Salesforce B2B Commerce Developer AP exam tips for ${RELEASE_CURRENT}: LWC customisation, headless commerce, cart and checkout APIs, and scenario strategy to pass first attempt.`
...
export default function B2bCommerceDeveloperApExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/b2b-commerce-developer-ap-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/b2b-commerce-developer-ap-exam-tips' })
