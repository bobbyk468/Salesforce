...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'B2B Solution Architect', url: '/certifications/b2b-solution-architect' },
...
export default function B2BSolutionArchitectExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/b2b-solution-architect-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/b2b-solution-architect-study-guide"
      />
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">At a Glance: What B2B Solution Architect Covers</h2>
