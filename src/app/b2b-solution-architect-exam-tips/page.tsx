...
const pageDescription =
  `Salesforce B2B Solution Architect exam tips for ${RELEASE_CURRENT}: multi-cloud B2B architecture, Sales Cloud, CPQ, Marketing Cloud B2B, and scenario strategy to pass first attempt.`
...
export default function B2BSolutionArchitectExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/b2b-solution-architect-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/b2b-solution-architect-exam-tips' })
