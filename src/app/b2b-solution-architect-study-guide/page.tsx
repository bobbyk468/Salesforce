    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-gray-50 rounded-xl border border-gray-100 p-5 mb-8">
        ...
        <ul className="space-y-2">
          <li><Link href="/b2b-vs-b2c-solution-architect" className="text-sm text-salesforce-blue hover:underline font-medium">→ B2B vs B2C Solution Architect — full certification comparison</Link></li>
        </ul>
      </div>
