...
const pageDescription =
  `Salesforce B2C Commerce Architect exam tips for ${RELEASE_CURRENT}: SFRA architecture, performance, security, integrations, and scenario strategy to pass first attempt.`
