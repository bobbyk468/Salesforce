...
export default function B2cCommerceArchitectStudyGuidePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/b2c-commerce-architect-study-guide" breadcrumbItems={breadcrumbItems} faqItems={faqItems} />
      <CredentialSchema
        certSlug="b2c-commerce-architect"
        certName="B2C Commerce Architect"
        description={pageDescription}
        pageUrl="/b2c-commerce-architect-study-guide"
      />
      ...
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white">
        ...
        <p className="text-white mb-6">Free practice questions for the Salesforce B2C Commerce Architect exam.</p>
      ...
      <DifficultyHeatmap slug="b2c-commerce-architect" />
      {/* Hub CTA */}
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white mt-10">
        ...
        <p className="text-white mb-6">Try the B2C Commerce Architect free practice exam — scored with full explanations.</p>
        <Link
