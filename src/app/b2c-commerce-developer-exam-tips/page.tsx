...
const pageDescription =
  `Salesforce B2C Commerce Developer exam tips for ${RELEASE_CURRENT}: SFRA, cartridges, controllers, ISML templates Free practice questions.`
...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'B2C Commerce Developer', url: '/certifications/b2c-commerce-developer' },
...
const faqItems = [
  ...
  ...getConceptFaqs('b2c-commerce-developer-exam-tips'),
]

export default function B2CCommerceDeveloperExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/b2c-commerce-developer-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/b2c-commerce-developer-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="b2c-commerce-developer-study-guide" certName="B2C Commerce Developer" />
      <ExamPricingCard
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">TL;DR: What B2C Commerce Developer Tests</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">SFRA + Business Logic + Business Manager = 75%. SFRA cartridge architecture is the foundation — master it first.</p>
        </div>
      </section>
