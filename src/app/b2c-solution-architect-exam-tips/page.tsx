...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'B2C Solution Architect', url: '/certifications/b2c-solution-architect' },
...
export default function B2CSolutionArchitectExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/b2c-solution-architect-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/b2c-solution-architect-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="b2c-solution-architect-study-guide" certName="B2C Solution Architect" />
      <ExamPricingCard
        certSlug="b2c-solution-architect"
        certName="B2C Solution Architect"
        certPageSlug="b2c-solution-architect"
      />


      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">Fast Facts: B2C Solution Architect Focus Areas</h2>
