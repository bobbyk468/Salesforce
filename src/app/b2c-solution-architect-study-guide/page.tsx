...
const pageDescription = `Salesforce B2C Solution Architect study guide (${RELEASE_CURRENT}): Commerce Cloud, Marketing Cloud, personalisation, omnichannel design. $400 fee, 60 questions, ~68% passing score.`
...
export default function B2cSolutionArchitectStudyGuidePage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/b2c-solution-architect-study-guide', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/b2c-solution-architect-study-guide' })
