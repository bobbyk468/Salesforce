...
export default function BusinessAnalystExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/business-analyst-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/business-analyst-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="business-analyst-study-guide" certName="Business Analyst" />
      <ExamPricingCard
