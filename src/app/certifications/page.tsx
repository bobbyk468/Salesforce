...
const indexDescription =
  `Browse all 90+ Salesforce certifications by role with ${RELEASE_CURRENT} exam weightage, free practice questions, and study guides. Find your cert path and start preparing now.`
    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-10">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p><strong className="text-gray-900">Consultant track:</strong> <Link href="/certifications/sales-cloud" className="text-salesforce-blue hover:underline">Sales Cloud</Link>, <Link href="/certifications/service-cloud" className="text-salesforce-blue hover:underline">Service Cloud</Link>, <Link href="/certifications/experience-cloud-consultant" className="text-salesforce-blue hover:underline">Experience Cloud</Link>, <Link href="/certifications/marketing-cloud-engagement-admin" className="text-salesforce-blue hover:underline">Marketing Cloud</Link>, and industry-specific credentials. Requires ADM-201 knowledge and real implementation experience. See the full <Link href="/consultant-certification-path" className="text-salesforce-blue hover:underline">Consultant certification path</Link>.</p>
