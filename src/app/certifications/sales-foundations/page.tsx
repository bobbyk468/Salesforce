      ...
      <CertPageSeo slug={slug} certTitle={slugToDisplayName(slug)} />
        ...
        <div className="lg:col-span-3">
          ...
          />
            ...
            <h2 id="next-certs-heading" className="text-base font-semibold text-gray-900 mb-3">Next Certifications</h2>
            <p className="text-sm text-gray-700 mb-2">After Sales Foundations, the usual next step is Platform Administrator, then consultant certs:</p>
