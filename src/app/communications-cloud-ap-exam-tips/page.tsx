...
const pageDescription =
  `Salesforce Communications Cloud Accredited Professional exam tips for ${RELEASE_CURRENT}: order management, product catalogue, contract management, and scenario strategy to pass.`
...
export default function CommunicationsCloudApExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/communications-cloud-ap-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/communications-cloud-ap-exam-tips' })
