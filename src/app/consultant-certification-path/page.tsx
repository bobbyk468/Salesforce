...
export default function ConsultantCertificationPathPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/consultant-certification-path', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/consultant-certification-path' })
    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <ul className="space-y-2 text-sm text-gray-700">
          <li className="flex gap-2"><CheckCircle2 className="h-4 w-4 mt-0.5 text-emerald-600 flex-shrink-0" /><strong>Pardot Specialist / Pardot Consultant</strong> — Marketing automation with Account Engagement. Specialist before Consultant. <Link href="/pardot-specialist-exam-tips" className="text-salesforce-blue hover:underline">Pardot exam tips</Link></li>
