...
export const metadata: Metadata = {
  ...
  canonical: `${siteUrl}/certifications/consumer-goods-cloud-ap`,
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
  ...
  keywords:
    `Consumer Goods Cloud AP exam tips ${RELEASE_CURRENT}, how to pass Consumer Goods Cloud AP, Salesforce CGC certification, retail execution exam study guide`,
}
...
export default function ConsumerGoodsCloudApExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/consumer-goods-cloud-ap-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/consumer-goods-cloud-ap-exam-tips' })
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">Quick Answer: What Consumer Goods Cloud AP Tests</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-500 pt-1">AP format: 40 questions, 60 minutes, Pass/Fail, $150. Retail Execution + KPI = 60% — understanding the field rep&apos;s in-store workflow is essential.</p>
        </div>
      </section>
