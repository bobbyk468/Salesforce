...
export const metadata: Metadata = {
  ...
  keywords:
    'CPQ Administrator vs CPQ Billing AP, Salesforce CPQ certification comparison, Revenue Cloud cert, CPQ exam which to take',
}
...
export default function CpqAdminVsCpqBillingApPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/cpq-admin-vs-cpq-billing-ap', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/cpq-admin-vs-cpq-billing-ap' })
          ...
          <table className="w-full text-sm text-left border-collapse">
            <thead>
              <tr className="border-b-2 border-gray-200">
                ...
                <th className="py-2.5 pr-4 font-semibold text-salesforce-blue">CPQ Administrator</th>
                <th className="py-2.5 font-semibold text-purple-700">CPQ &amp; Billing AP</th>
              </tr>
            </thead>
