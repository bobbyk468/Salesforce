...
export default function CpqAdminVsRevenueCloudConsultantPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/cpq-admin-vs-revenue-cloud-consultant', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/cpq-admin-vs-revenue-cloud-consultant' })
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100">
                ...
                <th className="text-left py-2 pr-4 text-salesforce-blue font-medium">CPQ Admin</th>
                <th className="text-left py-2 text-salesforce-blue font-medium">Revenue Cloud Consultant</th>
              </tr>
            </thead>
      ...
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white">
        ...
        <p className="text-blue-100 mb-6">Free practice questions for both quote-to-cash certifications.</p>
