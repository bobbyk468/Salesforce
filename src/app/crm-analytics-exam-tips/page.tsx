...
export default function CRMAnalyticsExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/crm-analytics-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/crm-analytics-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="crm-analytics-study-guide" certName="CRM Analytics & Einstein Discovery" />
      <ExamPricingCard
        certSlug="crm-analytics-einstein-discovery-consultant"
        certName="CRM Analytics Consultant"
        certPageSlug="crm-analytics-einstein-discovery-consultant"
      />


      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">At a Glance: What CRM Analytics Consultant Covers</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">Dashboards + Data Integration + Security = 68%. Row-level security and dataflow design are the most technically complex areas.</p>
        </div>
      </section>
