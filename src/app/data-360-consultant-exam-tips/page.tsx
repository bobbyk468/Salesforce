...
export default function DataCloudConsultantExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <StudyGuideCrossLink studyGuideSlug="data-360-consultant-study-guide" certName="Data 360 Consultant" />
      <ExamPricingCard
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">Ingestion + Segmentation + Identity = 75%. The end-to-end data flow from source to segment is the exam backbone.</p>
        </div>
      </section>
