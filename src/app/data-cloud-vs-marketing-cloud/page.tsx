...
export default function DataCloudVsMarketingCloudPage() {
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/data-cloud-vs-marketing-cloud" breadcrumbItems={breadcrumbItems} faqItems={faqItems} aboutEntities={['/certifications/data-360-consultant', '/certifications/marketing-cloud-consultant']} />
