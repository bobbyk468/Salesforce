...
export default function EducationCloudVsNonprofitCloudConsultantPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/education-cloud-vs-nonprofit-cloud-consultant', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/education-cloud-vs-nonprofit-cloud-consultant' })
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
        <div className="bg-white rounded-xl border-2 border-salesforce-blue p-6 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-xs font-semibold bg-salesforce-blue/10 text-salesforce-blue px-2 py-0.5 rounded-full">Higher Ed / K-12</span>
          </div>
      ...
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white">
        ...
        <p className="text-blue-100 mb-6">Free practice questions for both Education Cloud and Nonprofit Cloud certifications.</p>
