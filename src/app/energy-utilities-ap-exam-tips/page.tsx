...
const pageDescription =
  `Salesforce Energy &amp; Utilities Cloud Accredited Professional exam tips for ${RELEASE_CURRENT}: customer engagement, service management, OmniStudio.`
...
const faqItems = [
  ...
  ...getConceptFaqs('energy-utilities-ap-exam-tips'),
]

export default function EnergyUtilitiesApExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/energy-utilities-ap-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems} />
      <CredentialSchema
        certSlug="energy-utilities-ap"
        certName="Energy & Utilities AP"
        description={pageDescription}
        pageUrl="/energy-utilities-ap-exam-tips"
      />
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">Fast Facts: Energy &amp; Utilities Cloud AP Focus Areas</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">AP format: 40 questions, 60 minutes, Pass/Fail, $150. OmniStudio knowledge is essential — EUC digital services are built entirely on OmniStudio components.</p>
        </div>
      </section>
...
<section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link href="/public-sector-solutions-ap-exam-tips" className="flex items-center gap-2 p-3 rounded-lg border border-gray-100 hover:border-salesforce-blue/40 hover:bg-salesforce-blue/5 transition-colors group">
            <ArrowRight className="h-4 w-4 text-salesforce-blue flex-shrink-0" />
            <span className="text-sm font-medium text-gray-800 group-hover:text-salesforce-blue">Public Sector Solutions AP Exam Tips</span>
          </Link>
