...
export default function ExperienceCloudConsultantStudyGuidePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <CredentialSchema
        certSlug="experience-cloud-consultant"
        certName="Experience Cloud Consultant"
        description={pageDescription}
        pageUrl="/experience-cloud-consultant-study-guide"
      />
      ...
      <ContentPageAuthor />
      <ExamTipsCrossLink examTipsSlug="experience-cloud-exam-tips" certName="Experience Cloud Consultant" />
      <CertInsightBlock certSlug="experience-cloud-consultant" />
      <ExamPricingCard
