...
const pageDescription =
  `Experience Cloud Consultant exam tips for ${RELEASE_CURRENT}: portal design, member management, security, and scenario strategy to pass first attempt.`
...
export default function ExperienceCloudExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/experience-cloud-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/experience-cloud-exam-tips' })
