...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'Experience Cloud Consultant', url: '/certifications/experience-cloud' },
...
const faqItems = [
  ...
  ...getConceptFaqs('experience-cloud-exam-tips'),
]

export default function ExperienceCloudExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/experience-cloud-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/experience-cloud-consultant-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="experience-cloud-consultant-study-guide" certName="Experience Cloud Consultant" />
      <ExamPricingCard
        certSlug="experience-cloud"
        certName="Experience Cloud Consultant"
        certPageSlug="experience-cloud"
      />
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">Sharing + Branding = 51% of the exam. Licence types and sharing sets are your single highest-ROI study topics.</p>
        </div>
      </section>
      ...
      <section className="rounded-xl border border-salesforce-blue/20 bg-salesforce-blue/5 p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Link href="/certifications/experience-cloud" className="inline-flex items-center justify-center gap-2 px-5 py-3 bg-salesforce-blue text-white rounded-lg font-semibold hover:bg-salesforce-dark transition-colors">
            Experience Cloud Practice Test <ArrowRight className="h-4 w-4" />
          </Link>
