...
export default function FinancialServicesCloudApExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <CredentialSchema
        certSlug="financial-services-cloud-ap"
        certName="Financial Services Cloud AP"
        description={pageDescription}
        pageUrl="/financial-services-cloud-ap-exam-tips"
      />
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">At a Glance: What FSC AP Covers</h2>
