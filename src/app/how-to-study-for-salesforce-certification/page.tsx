...
export default function HowToStudyForSalesforceCertificationPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/how-to-study-for-salesforce-certification', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/how-to-study-for-salesforce-certification' })
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white">
        ...
        <p className="text-blue-100 mb-6">Put the study method into practice — free scenario-based questions for every Salesforce certification.</p>
