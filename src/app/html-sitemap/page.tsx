...
const corePages = [
  ...
  { name: 'Marketing Cloud Certification Path', href: '/marketing-cloud-certification-path' },
  { name: 'ADM-201 Exam Tips', href: '/adm-201-exam-tips' },
  { name: 'ADM-201 vs App Builder', href: '/adm-201-vs-app-builder' },
  { name: 'PD1 Exam Tips', href: '/pd1-exam-tips' },
  ...
  { name: 'Service Cloud Study Guide', href: '/service-cloud-consultant-study-guide' },
  ...
  { name: 'Data Cloud Consultant Study Guide', href: '/data-360-consultant-study-guide' },
  ...
  { name: 'PD2 Exam Tips', href: '/pd2-exam-tips' },
  ...
  { name: 'Data Cloud Consultant Exam Tips', href: '/data-360-consultant-exam-tips' },
  ...
  { name: 'Integration Architect Study Guide', href: '/integration-architect-study-guide' },
  { name: 'Data Architect Study Guide', href: '/data-architect-study-guide' },
  { name: 'Sharing & Visibility Architect Study Guide', href: '/sharing-visibility-architect-study-guide' },
  { name: 'IAM Architect Study Guide', href: '/identity-access-management-architect-study-guide' },
  { name: 'Dev Lifecycle & Deployment Architect Study Guide', href: '/dev-lifecycle-deployment-architect-study-guide' },
  { name: 'Pardot Specialist Study Guide', href: '/pardot-specialist-study-guide' },
  { name: 'CRM Analytics Study Guide', href: '/crm-analytics-study-guide' },
  { name: 'B2B Solution Architect Study Guide', href: '/b2b-solution-architect-study-guide' },
  { name: 'B2C Solution Architect Study Guide', href: '/b2c-solution-architect-study-guide' },
  { name: 'MuleSoft Integration Foundations Study Guide', href: '/mulesoft-integration-foundations-study-guide' },
  { name: 'Marketing Cloud Engagement Admin Study Guide', href: '/marketing-cloud-engagement-admin-study-guide' },
  { name: 'B2C Commerce Developer Study Guide', href: '/b2c-commerce-developer-study-guide' },
  { name: 'Pardot Specialist vs Pardot Consultant', href: '/pardot-specialist-vs-pardot-consultant' },
  { name: 'CPQ Admin vs Revenue Cloud Consultant', href: '/cpq-admin-vs-revenue-cloud-consultant' },
  { name: 'Salesforce Certification Voucher Guide', href: '/salesforce-certification-voucher' },
  { name: 'Salesforce Exam Retake Policy', href: '/salesforce-exam-retake-policy' },
  { name: 'Salesforce Certification Validity & Expiry', href: '/salesforce-certification-validity' },
  { name: 'How to Register for a Salesforce Exam', href: '/how-to-register-salesforce-exam' },
  { name: 'How to Get a Free Salesforce Certification', href: '/salesforce-free-certification' },
  { name: 'System Architect Study Guide', href: '/system-architect-study-guide' },
  { name: 'Application Architect Study Guide', href: '/application-architect-study-guide' },
  { name: 'UX Designer Study Guide', href: '/ux-designer-study-guide' },
  { name: 'Strategy Designer Study Guide', href: '/strategy-designer-study-guide' },
  { name: 'Pardot Consultant Study Guide', href: '/pardot-consultant-study-guide' },
  { name: 'Marketing Cloud Engagement Developer Study Guide', href: '/marketing-cloud-engagement-developer-study-guide' },
  { name: 'Education Cloud Consultant Study Guide', href: '/education-cloud-consultant-study-guide' },
  { name: 'Nonprofit Cloud Consultant Study Guide', href: '/nonprofit-cloud-consultant-study-guide' },
  { name: 'Platform Foundations Study Guide', href: '/platform-foundations-study-guide' },
  { name: 'Technical Architect Study Guide', href: '/technical-architect-study-guide' },
  { name: 'Marketing Cloud Engagement Foundations Study Guide', href: '/marketing-cloud-engagement-foundations-study-guide' },
  { name: 'Slack Administrator Study Guide', href: '/slack-administrator-study-guide' },
  { name: 'MuleSoft Integration Architect Study Guide', href: '/mulesoft-integration-architect-study-guide' },
  { name: 'MuleSoft Platform Architect Study Guide', href: '/mulesoft-platform-architect-study-guide' },
  { name: 'Nonprofit Success Pack Consultant Study Guide', href: '/nonprofit-success-pack-consultant-study-guide' },
  { name: 'B2C Commerce Architect Study Guide', href: '/b2c-commerce-architect-study-guide' },
  { name: 'UX Designer vs Strategy Designer', href: '/ux-designer-vs-strategy-designer' },
  { name: 'System Architect vs Application Architect', href: '/system-architect-vs-application-architect' },
  { name: 'Pardot Consultant vs Marketing Cloud Consultant', href: '/pardot-consultant-vs-marketing-cloud-consultant' },
  { name: 'Platform Foundations vs AI Associate', href: '/platform-foundations-vs-ai-associate' },
  { name: 'Education Cloud vs Nonprofit Cloud Consultant', href: '/education-cloud-vs-nonprofit-cloud-consultant' },
  { name: 'Which Salesforce Certification First?', href: '/which-salesforce-certification-first' },
  { name: 'How to Study for Salesforce Certification', href: '/how-to-study-for-salesforce-certification' },
  { name: 'Salesforce Certification Exam Day Tips', href: '/salesforce-certification-exam-day-tips' },
  { name: 'Salesforce Admin vs Developer Career', href: '/salesforce-admin-vs-developer-career' },
  { name: 'Salesforce Certification Passing Score', href: '/salesforce-certification-passing-score' },
