...
export const metadata: Metadata = {
  ...
  canonical: `${siteUrl}/certifications/identity-access-management-architect`,
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
...
export default function IamArchitectExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/identity-access-management-architect-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems} />
