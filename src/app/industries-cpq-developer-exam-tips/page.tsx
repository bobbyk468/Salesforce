...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${siteUrl}/certifications/industries-cpq-developer` },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    type: 'article',
...
const faqItems = [
  ...
  ...getConceptFaqs('industries-cpq-developer-exam-tips'),
]
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">Product Catalogue + Pricing + Guided Selling = 77%. These three areas define your preparation focus.</p>
        </div>
      </section>
