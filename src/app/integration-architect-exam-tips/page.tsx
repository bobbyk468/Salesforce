...
export const metadata: Metadata = {
  ...
  canonical: `${siteUrl}/certifications/integration-architect`,
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
...
export default function IntegrationArchitectExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/integration-architect-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems} />
      ...
      <section className="rounded-xl border border-gray-100 bg-gray-50 p-5 mb-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
          ...
          <div>
            <p className="text-2xl font-bold text-salesforce-blue">62%</p>
