  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <CredentialSchema
        ...
        description={pageDescription}
        pageUrl="/integration-architect-study-guide"
      />
      ...
      <ContentPageAuthor />
      <ExamTipsCrossLink examTipsSlug="integration-architect-exam-tips" certName="Integration Architect" />
      <CertInsightBlock certSlug="integration-architect" />
      <ExamPricingCard
        certSlug="integration-architect"
        certName="Integration Architect"
      ...
      <DifficultyHeatmap slug="integration-architect" />
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white">
        <h2 className="text-2xl font-bold mb-2">Try It Yourself</h2>
        <p className="text-white mb-6">Test yourself with free Integration Architect practice questions covering all 5 exam sections.</p>
        <Link
