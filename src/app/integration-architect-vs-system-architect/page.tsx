...
export default function IntegrationArchitectVsSystemArchitectPage() {
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/integration-architect-vs-system-architect" breadcrumbItems={breadcrumbItems} faqItems={faqItems} />
