...
export default function JavascriptDeveloperIStudyGuidePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <DifficultyHeatmap slug="javascript-developer-i" />
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white">
        <h2 className="text-2xl font-bold mb-2">Ready to Practice?</h2>
        <p className="text-white mb-6">Test yourself with free JavaScript Developer I practice questions covering all 6 exam sections.</p>
        <Link
