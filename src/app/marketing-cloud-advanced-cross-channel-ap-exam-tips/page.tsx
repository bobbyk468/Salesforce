...
export default function MarketingCloudAdvancedCrossChannelApExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <CredentialSchema
        certSlug="marketing-cloud-advanced-cross-channel-ap"
        certName="Marketing Cloud Advanced Cross-Channel AP"
        description={pageDescription}
        pageUrl="/marketing-cloud-advanced-cross-channel-ap-exam-tips"
      />
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">TL;DR: What MC Advanced Cross-Channel AP Tests</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">AP format: 40 questions, 60 minutes, Pass/Fail, $150. Advanced Journey Builder = 35% — complex multi-channel journey design is the core skill tested.</p>
        </div>
      </section>
