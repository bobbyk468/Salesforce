...
const pageTitle = `Marketing Cloud Consultant Exam Tips (${RELEASE_CURRENT}): Study Guide`
...
export const metadata: Metadata = {
  ...
  canonical: `${siteUrl}/certifications/marketing-cloud-consultant`,
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
...
export default function MarketingCloudConsultantExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/marketing-cloud-consultant-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/marketing-cloud-consultant-exam-tips' })
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-500 pt-1">Discovery and Architecture + Account Configuration = 50%. These are your highest-ROI study areas.</p>
        </div>
      </section>
