...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'Marketing Cloud Consultant', url: '/certifications/marketing-cloud-consultant' },
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <ExamPricingCard
        certSlug="marketing-cloud-consultant"
        certName="Marketing Cloud Consultant"
        certPageSlug="marketing-cloud-consultant"
      />
      ...
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white mt-10">
        ...
        <p className="text-white mb-6">Try the Marketing Cloud Consultant free practice exam — scored with full explanations.</p>
        <Link
        ...
        >
          Marketing Cloud Consultant Free Practice Exam &rarr;
        </Link>
      </div>
    </div>
  )
