...
const pageDescription =
  `Marketing Cloud Consultant study guide (${RELEASE_CURRENT}): discovery and architecture, integration, data management, Journey Builder, and scenario strategies to pass first attempt.`
...
export default function MarketingCloudConsultantStudyGuidePage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/marketing-cloud-consultant-study-guide', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/marketing-cloud-consultant-study-guide' })
