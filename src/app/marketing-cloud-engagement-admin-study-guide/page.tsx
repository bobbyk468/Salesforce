...
const pageTitle = `Marketing Cloud Engagement Admin Study Guide (${RELEASE_CURRENT})`
const pageDescription = `Salesforce Marketing Cloud Engagement Administrator study guide (${RELEASE_CURRENT}): account setup, business units, data management, compliance. $200 fee, 60 questions, ~67% passing score.`
...
export const metadata: Metadata = {
  ...
  keywords: `marketing cloud engagement admin study guide, marketing cloud administrator certification 2026, SFMC admin exam prep, salesforce marketing cloud admin`,
}
...
export default function MarketingCloudEngagementAdminStudyGuidePage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/marketing-cloud-engagement-admin-study-guide', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/marketing-cloud-engagement-admin-study-guide' })
