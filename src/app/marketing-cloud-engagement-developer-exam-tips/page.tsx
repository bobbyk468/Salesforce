...
const pageDescription =
  `Salesforce Marketing Cloud Developer exam tips for ${RELEASE_CURRENT}: AMPscript, SSJS, SQL queries, API integration, and scenario strategy to pass first attempt.`
...
export default function MarketingCloudEngagementDeveloperExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/marketing-cloud-engagement-developer-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/marketing-cloud-engagement-developer-exam-tips' })
