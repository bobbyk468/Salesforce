...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'Marketing Cloud Engagement Developer', url: '/certifications/marketing-cloud-engagement-developer' },
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <CredentialSchema
        ...
        certName="Marketing Cloud Engagement Developer"
        description={pageDescription}
        pageUrl="/marketing-cloud-engagement-developer-study-guide"
      />
      ...
      <ContentPageAuthor />
      <ExamTipsCrossLink examTipsSlug="marketing-cloud-engagement-developer-exam-tips" certName="Marketing Cloud Engagement Developer" />
      <CertInsightBlock certSlug="marketing-cloud-engagement-developer" />
      <ExamPricingCard
        certSlug="marketing-cloud-engagement-developer"
        certName="Marketing Cloud Engagement Developer"
        certPageSlug="marketing-cloud-engagement-developer"
      />
      ...
      <div className="bg-gray-50 rounded-xl border border-gray-100 p-5 mb-8">
        ...
        <p className="text-sm text-gray-700">
          After this certification, consider: <Link href="/certifications/marketing-cloud-consultant" className="text-salesforce-blue font-medium hover:underline">Marketing Cloud Engagement Consultant</Link>, <Link href="/certifications/pardot-consultant" className="text-salesforce-blue font-medium hover:underline">Marketing Cloud Account Engagement Consultant</Link>, or <Link href="/certifications/email-specialist" className="text-salesforce-blue font-medium hover:underline">Marketing Cloud Email Specialist</Link>.
        </p>
      </section>
