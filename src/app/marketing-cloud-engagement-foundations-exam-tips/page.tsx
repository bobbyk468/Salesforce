...
export default function MarketingCloudEngagementFoundationsExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/marketing-cloud-engagement-foundations-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/marketing-cloud-engagement-foundations-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="marketing-cloud-engagement-foundations-study-guide" certName="Marketing Cloud Engagement Foundations" />
      <ExamPricingCard
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">Fast Facts: Marketing Cloud Foundations Focus Areas</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">Email Studio + Subscriber Management + Platform = 77%. CAN-SPAM compliance and subscriber statuses are frequently tested in compliance questions.</p>
        </div>
      </section>
