...
const pageDescription =
  `Salesforce Marketing Cloud Intelligence (Datorama) AP exam tips for ${RELEASE_CURRENT}: data streams, harmonisation, dashboards, KPIs, and scenario strategy to pass first attempt.`
...
export default function MarketingCloudIntelligenceApExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/marketing-cloud-intelligence-ap-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/marketing-cloud-intelligence-ap-exam-tips' })
