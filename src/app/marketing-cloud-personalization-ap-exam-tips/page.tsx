...
const faqItems = [
  ...
  ...getConceptFaqs('marketing-cloud-personalization-ap-exam-tips'),
]
...
export default function MarketingCloudPersonalizationApExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <CredentialSchema
        certSlug="marketing-cloud-personalization-ap"
        certName="Marketing Cloud Personalization AP"
        description={pageDescription}
        pageUrl="/marketing-cloud-personalization-ap-exam-tips"
      />
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">At a Glance: What MCP AP Covers</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">AP format: 40 questions, 60 minutes, Pass/Fail, $150. Einstein Recipes configuration is the most distinctive topic — know Ingredients, Boosters, and Exclusions thoroughly.</p>
        </div>
      </section>
