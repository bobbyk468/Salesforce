...
const pageDescription =
  `Salesforce Media Cloud Accredited Professional exam tips for ${RELEASE_CURRENT}: media sales, order management, subscriber management, and scenario strategy to pass first attempt.`
