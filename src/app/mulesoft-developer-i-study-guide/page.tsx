...
export const metadata: Metadata = {
  ...
  keywords: `mulesoft developer i study guide, MCIA-Level-1 exam prep, mulesoft certification 2026, anypoint platform developer certification`,
}
...
export default function MulesoftDeveloperIStudyGuidePage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/mulesoft-developer-i-study-guide', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/mulesoft-developer-i-study-guide' })
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white">
        ...
        <p className="text-blue-100 mb-6">Test yourself with free MuleSoft Developer I practice questions covering all exam sections.</p>
        <Link
