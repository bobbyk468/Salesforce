...
export default function MulesoftDeveloperIVsIIPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/mulesoft-developer-i-vs-ii', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/mulesoft-developer-i-vs-ii' })
          ...
          <table className="w-full text-sm text-left border-collapse">
            <thead>
              <tr className="border-b-2 border-gray-200">
                ...
                <th className="py-2.5 pr-4 font-semibold text-salesforce-blue">MuleSoft Developer I</th>
                <th className="py-2.5 font-semibold text-purple-700">MuleSoft Developer II</th>
              </tr>
            </thead>
