...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'MuleSoft Developer II', url: '/certifications/mulesoft-developer-ii' },
...
export default function MuleSoftDeveloperIIExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/mulesoft-developer-ii-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/mulesoft-developer-ii-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="mulesoft-developer-ii-study-guide" certName="MuleSoft Developer II" />
      <ExamPricingCard
        certSlug="mulesoft-developer-ii"
        certName="MuleSoft Developer II"
        certPageSlug="mulesoft-developer-ii"
      />


      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">TL;DR: What MuleSoft Developer II Tests</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">API-led + Platform Management + Anypoint MQ = 70%. Three-tier architecture design is the highest-value study area.</p>
        </div>
      </section>
