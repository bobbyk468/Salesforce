...
const pageDescription =
  `MuleSoft Developer II exam tips for ${RELEASE_CURRENT}: API-led connectivity, Anypoint MQ, batch processing, custom policies, and scenario strategy to pass first attempt.`
...
export default function MuleSoftDeveloperIIExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/mulesoft-developer-ii-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/mulesoft-developer-ii-exam-tips' })
