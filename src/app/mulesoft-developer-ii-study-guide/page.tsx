...
const pageDescription = `MuleSoft Developer II study guide (${RELEASE_CURRENT}): 5 exam sections, advanced DataWeave, batch processing, security, deployment, and free practice questions. $200 fee.`
...
export default function MulesoftDeveloperIiStudyGuidePage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/mulesoft-developer-ii-study-guide', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/mulesoft-developer-ii-study-guide' })
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white">
        ...
        <p className="text-blue-100 mb-6">Test yourself with free MuleSoft Developer II practice questions.</p>
