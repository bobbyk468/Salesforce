...
export default function MulesoftIntegrationFoundationsStudyGuidePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/mulesoft-integration-foundations-study-guide" breadcrumbItems={breadcrumbItems} faqItems={faqItems} />
      <CredentialSchema
        certSlug="mulesoft-integration-foundations"
        certName="MuleSoft Integration Foundations"
        description={pageDescription}
        pageUrl="/mulesoft-integration-foundations-study-guide"
      />
      ...
      <ContentPageAuthor />
      <ExamTipsCrossLink examTipsSlug="mulesoft-integration-foundations-exam-tips" certName="MuleSoft Integration Foundations" />
      <CertInsightBlock certSlug="mulesoft-integration-foundations" />
      <ExamPricingCard
        certSlug="mulesoft-integration-foundations"
        certName="MuleSoft Integration Foundations"
