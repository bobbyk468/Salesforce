...
export default function MuleSoftPlatformArchitectExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/mulesoft-platform-architect-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/mulesoft-platform-architect-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="mulesoft-platform-architect-study-guide" certName="MuleSoft Platform Architect" />
      <ExamPricingCard
        certSlug="mulesoft-platform-architect"
        certName="MuleSoft Platform Architect"
        certPageSlug="mulesoft-platform-architect"
      />
