  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <CredentialSchema
        ...
        description={pageDescription}
        pageUrl="/mulesoft-platform-architect-study-guide"
      />
      ...
      <ContentPageAuthor />
      <ExamTipsCrossLink examTipsSlug="mulesoft-platform-architect-exam-tips" certName="MuleSoft Platform Architect" />
      <CertInsightBlock certSlug="mulesoft-platform-architect" />
      <ExamPricingCard
        certSlug="mulesoft-platform-architect"
        certName="MuleSoft Platform Architect"
