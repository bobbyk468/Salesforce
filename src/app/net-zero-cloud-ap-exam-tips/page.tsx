...
export const metadata: Metadata = {
  ...
  canonical: `${siteUrl}/certifications/net-zero-cloud-ap`,
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
...
export default function NetZeroCloudApExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/net-zero-cloud-ap-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/net-zero-cloud-ap-exam-tips' })
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-500 pt-1">AP format: 40 questions, 60 minutes, Pass/Fail, $150. Knowing Scope 1/2/3 definitions and GHG Protocol methodology is the foundation for all carbon accounting questions.</p>
        </div>
      </section>
