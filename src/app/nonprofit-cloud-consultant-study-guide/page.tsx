...
export default function NonprofitCloudConsultantStudyGuidePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <CredentialSchema
        certSlug="nonprofit-cloud-consultant"
        certName="Nonprofit Cloud Consultant"
        description={pageDescription}
        pageUrl="/nonprofit-cloud-consultant-study-guide"
      />
      ...
      <ContentPageAuthor />
      <ExamTipsCrossLink examTipsSlug="nonprofit-cloud-exam-tips" certName="Nonprofit Cloud Consultant" />
      <CertInsightBlock certSlug="nonprofit-cloud-consultant" />
      <ExamPricingCard
