...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'Nonprofit Cloud Consultant', url: '/certifications/nonprofit-cloud' },
...
const faqItems = [
  ...
  ...getConceptFaqs('nonprofit-cloud-exam-tips'),
]

export default function NonprofitCloudExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/nonprofit-cloud-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/nonprofit-cloud-consultant-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="nonprofit-cloud-consultant-study-guide" certName="Nonprofit Cloud Consultant" />
      <ExamPricingCard
        certSlug="nonprofit-cloud"
        certName="Nonprofit Cloud Consultant"
        certPageSlug="nonprofit-cloud"
      />
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">Fundraising + Programme + NPC Model = 77%. Understand the NPC data model deeply before attempting mock tests.</p>
        </div>
      </section>
