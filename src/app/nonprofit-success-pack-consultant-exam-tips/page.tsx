...
export default function NPSPConsultantExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/nonprofit-success-pack-consultant-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/nonprofit-success-pack-consultant-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="nonprofit-success-pack-consultant-study-guide" certName="Nonprofit Success Pack Consultant" />
      <ExamPricingCard
