...
const pageDescription = `NPSP Consultant study guide: exam sections, household data model, fundraising, gift management. Pass in 2026 Free practice questions.`
...
export default function NonprofitSuccessPackConsultantStudyGuidePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/nonprofit-success-pack-consultant-study-guide" breadcrumbItems={breadcrumbItems} faqItems={faqItems} />
      <CredentialSchema
        certSlug="nonprofit-success-pack-consultant"
        certName="Nonprofit Success Pack Consultant"
        description={pageDescription}
        pageUrl="/nonprofit-success-pack-consultant-study-guide"
      />
      ...
      <DifficultyHeatmap slug="nonprofit-success-pack-consultant" />
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white">
        <h2 className="text-2xl font-bold mb-2">Practice NPSP Consultant Questions</h2>
        <p className="text-white mb-6">Free practice questions for the Salesforce NPSP Consultant exam.</p>
