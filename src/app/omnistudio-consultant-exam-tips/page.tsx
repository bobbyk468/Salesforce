...
export default function OmniStudioConsultantExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/omnistudio-consultant-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/omnistudio-consultant-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="omnistudio-consultant-study-guide" certName="OmniStudio Consultant" />
      <ExamPricingCard
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">TL;DR: What OmniStudio Consultant Tests</h2>
