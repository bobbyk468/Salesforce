...
const pageDescription = `Salesforce OmniStudio Consultant study guide (${RELEASE_CURRENT}): 4 exam sections, solution design, discovery, implementation tips, and free practice questions. $200 fee.`
...
export default function OmnistudioConsultantStudyGuidePage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/omnistudio-consultant-study-guide', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/omnistudio-consultant-study-guide' })
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white">
        ...
        <p className="text-blue-100 mb-6">Test yourself with free OmniStudio Consultant practice questions.</p>
