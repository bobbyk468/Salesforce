...
export default function OmnistudioDeveloperVsConsultantPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/omnistudio-developer-vs-consultant', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/omnistudio-developer-vs-consultant' })
          ...
          <table className="w-full text-sm text-left border-collapse">
            <thead>
              <tr className="border-b-2 border-gray-200">
                ...
                <th className="py-2.5 pr-4 font-semibold text-salesforce-blue">OmniStudio Consultant</th>
                <th className="py-2.5 font-semibold text-purple-700">OmniStudio Developer</th>
              </tr>
            </thead>
