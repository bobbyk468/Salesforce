...
export default function OmnistudioDeveloperVsConsultantPage() {
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/omnistudio-developer-vs-consultant" breadcrumbItems={breadcrumbItems} faqItems={faqItems} aboutEntities={['/certifications/omnistudio-developer', '/certifications/omnistudio-consultant']} />
