...
const pageDescription =
  `Salesforce Order Management Administrator AP exam tips for ${RELEASE_CURRENT}: order lifecycle, fulfilment, returns, inventory management, and scenario strategy to pass first attempt.`
