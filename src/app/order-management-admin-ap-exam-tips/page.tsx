...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${siteUrl}/order-management-admin-ap-exam-tips` },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    type: 'article',
...
const faqItems = [
  ...
  ...getConceptFaqs('order-management-admin-ap-exam-tips'),
]

export default function OrderManagementAdminApExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/order-management-admin-ap-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems} />
      <CredentialSchema
        certSlug="order-management-admin-ap"
        certName="Order Management Admin AP"
        description={pageDescription}
        pageUrl="/order-management-admin-ap-exam-tips"
      />
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">AP format: 40 questions, 60 minutes, Pass/Fail, $150. The OMS data model (Order Summary → Fulfilment Order → Order Delivery Group) is the foundation — know these objects and their relationships.</p>
        </div>
      </section>
