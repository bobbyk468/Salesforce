...
export default function PardotConsultantVsMarketingCloudConsultantPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/pardot-consultant-vs-marketing-cloud-consultant', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/pardot-consultant-vs-marketing-cloud-consultant' })
