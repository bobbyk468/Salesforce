...
const pageDescription = `Salesforce Pardot (Marketing Cloud Account Engagement) Specialist study guide (${RELEASE_CURRENT}): 5 exam sections, 8-week plan, scoring & grading, Engagement Studio. $200 fee, 60 questions.`
...
export default function PardotSpecialistStudyGuidePage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/pardot-specialist-study-guide', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/pardot-specialist-study-guide' })
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white">
        ...
        <p className="text-blue-100 mb-6">Free Pardot Specialist practice questions covering all 5 exam sections.</p>
        <Link
