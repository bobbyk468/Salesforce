...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'Platform Developer I', url: '/certifications/developer-1' },
...
export default function Pd1StudyGuidePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/pd1-study-guide" breadcrumbItems={breadcrumbItems} faqItems={faqItems} />
      <CredentialSchema
        certSlug="pd1"
        certName="Platform Developer I"
        description={pageDescription}
        pageUrl="/pd1-study-guide"
      />
  ...
  Map<Id, Contact> contacts = new Map<Id, Contact>(
    [SELECT Id, AccountId FROM Contact WHERE AccountId IN :accountIds]
      ...
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white mt-10">
        ...
        <p className="text-white mb-6">Try the Platform Developer I (PD1) free practice exam — scored with full explanations.</p>
        <Link
          href="/certifications/developer-1"
        ...
        >
          Platform Developer I (PD1) Free Practice Exam &rarr;
        </Link>
      </div>
    </div>
  )
