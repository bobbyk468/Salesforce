...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'Platform Foundations', url: '/certifications/platform-foundations' },
...
export default function PlatformFoundationsExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/platform-foundations-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/platform-foundations-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="platform-foundations-study-guide" certName="Platform Foundations" />
      <ExamPricingCard
        certSlug="platform-foundations"
        certName="Platform Foundations"
        certPageSlug="platform-foundations"
      />
