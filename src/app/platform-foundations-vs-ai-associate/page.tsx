...
export default function PlatformFoundationsVsAiAssociatePage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/platform-foundations-vs-ai-associate', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/platform-foundations-vs-ai-associate' })
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
        <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-xs font-semibold bg-salesforce-blue/10 text-salesforce-blue px-2 py-0.5 rounded-full">Most Recommended</span>
          </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100">
                ...
                <th className="text-left py-2 pr-4 text-gray-500 font-medium">AI Associate</th>
                <th className="text-left py-2 text-gray-500 font-medium">Platform Foundations</th>
              </tr>
            </thead>
      ...
      <div className="bg-salesforce-blue rounded-xl p-8 text-center text-white">
        ...
        <p className="text-blue-100 mb-6">The most accessible entry point into Salesforce certifications. Free practice questions available now.</p>
