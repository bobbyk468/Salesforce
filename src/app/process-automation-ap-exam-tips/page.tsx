...
const faqItems = [
  ...
  ...getConceptFaqs('process-automation-ap-exam-tips'),
]

export default function ProcessAutomationApExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/process-automation-ap-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems} />
      <CredentialSchema
        certSlug="process-automation-ap"
        certName="Process Automation AP"
        description={pageDescription}
        pageUrl="/process-automation-ap-exam-tips"
      />
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">Fast Facts: Process Automation AP Focus Areas</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">AP format: 40 questions, 60 minutes, Pass/Fail, $150. Advanced Flow + Strategy = 60% — this is not an entry-level Flow exam.</p>
        </div>
      </section>
