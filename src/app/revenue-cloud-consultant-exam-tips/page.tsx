...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'Revenue Cloud Consultant', url: '/certifications/revenue-cloud-consultant' },
...
const faqItems = [
  ...
  ...getConceptFaqs('revenue-cloud-consultant-exam-tips'),
]

export default function RevenueCloudConsultantExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/revenue-cloud-consultant-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/revenue-cloud-consultant-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="revenue-cloud-consultant-study-guide" certName="Revenue Cloud Consultant" />
      <ExamPricingCard
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">TL;DR: What Revenue Cloud Consultant Tests</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">CPQ + Billing + Subscriptions = 75%. The quote-to-cash lifecycle is the entire exam — know each stage deeply.</p>
        </div>
      </section>
