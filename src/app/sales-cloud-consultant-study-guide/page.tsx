...
export default function SalesCloudConsultantStudyGuidePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <CredentialSchema
        certSlug="sales-cloud-consultant"
        certName="Sales Cloud Consultant"
        description={pageDescription}
        pageUrl="/sales-cloud-consultant-study-guide"
      />
      ...
      <ContentPageAuthor />
      <ExamTipsCrossLink examTipsSlug="sales-cloud-exam-tips" certName="Sales Cloud Consultant" />
      <CertInsightBlock certSlug="sales-cloud-consultant" />
      <ExamPricingCard
