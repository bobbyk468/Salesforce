...
export default function SalesCloudExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/sales-cloud-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/sales-cloud-consultant-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="sales-cloud-consultant-study-guide" certName="Sales Cloud Consultant" />
      <ExamPricingCard
        certSlug="sales-cloud"
        certName="Sales Cloud Consultant"
        certPageSlug="sales-cloud"
      />


      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">TL;DR: What Sales Cloud Consultant Tests</h2>
