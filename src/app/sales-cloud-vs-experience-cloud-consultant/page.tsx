...
export default function SalesCloudVsExperienceCloudConsultantPage() {
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/sales-cloud-vs-experience-cloud-consultant" breadcrumbItems={breadcrumbItems} faqItems={faqItems} aboutEntities={['/certifications/sales-cloud', '/certifications/experience-cloud']} />
