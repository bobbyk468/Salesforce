...
export default function SalesCloudVsExperienceCloudConsultantPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/sales-cloud-vs-experience-cloud-consultant', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/sales-cloud-vs-experience-cloud-consultant' })
          ...
          <table className="w-full text-sm text-left border-collapse">
            <thead>
              <tr className="border-b-2 border-gray-200">
                ...
                <th className="py-2.5 font-semibold text-emerald-700">Experience Cloud Consultant</th>
              </tr>
            </thead>
