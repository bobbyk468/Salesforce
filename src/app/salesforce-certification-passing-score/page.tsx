...
export default function SalesforceCertificationPassingScorePage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/salesforce-certification-passing-score', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/salesforce-certification-passing-score' })
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100">
                ...
                <th className="text-left py-2 pr-4 text-gray-500 font-medium">Exam Fee</th>
                <th className="text-left py-2 pr-4 text-gray-500 font-medium">Typical Passing Score</th>
