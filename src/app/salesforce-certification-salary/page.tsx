...
const pageTitle = `Salesforce Certification Salary (${RELEASE_CURRENT}): How Much Do Certified Professionals Earn?`
...
export default function SalesforceCertificationSalaryPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/salesforce-certification-salary', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/salesforce-certification-salary' })
