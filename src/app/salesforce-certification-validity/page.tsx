...
export default function SalesforceCertificationValidityPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/salesforce-certification-validity', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/salesforce-certification-validity' })
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100">
                ...
                <th className="text-left py-2 pr-4 text-gray-500 font-medium">Expiry</th>
                <th className="text-left py-2 text-gray-500 font-medium">Renewal requirement</th>
              </tr>
            </thead>
