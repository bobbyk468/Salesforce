...
const faqItems = [
  ...
  ...getConceptFaqs('service-cloud-consultant-exam-tips'),
]

export default function ServiceCloudConsultantExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/service-cloud-consultant-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/service-cloud-consultant-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="service-cloud-consultant-study-guide" certName="Service Cloud Consultant" />
      <ExamPricingCard
