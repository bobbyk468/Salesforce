...
export const metadata: Metadata = {
  ...
  keywords:
    `Service Cloud Consultant study guide ${RELEASE_CURRENT}, how to pass Service Cloud Consultant exam, Salesforce Service Cloud certification prep, Omni-Channel entitlement management exam, Service Cloud exam sections`,
}
...
export default function ServiceCloudConsultantStudyGuidePage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/service-cloud-consultant-study-guide', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/service-cloud-consultant-study-guide' })
