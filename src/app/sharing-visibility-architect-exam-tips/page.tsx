...
export default function SharingVisibilityArchitectExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/sharing-visibility-architect-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/sharing-visibility-architect-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="sharing-visibility-architect-study-guide" certName="Sharing & Visibility Architect" />
      <ExamPricingCard
