...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/salesforce-certification-roi-calculator`, lastModified: new Date(RELEASE_DATE), changeFrequency: 'monthly', priority: 0.85 },
    ...
    { url: `${baseUrl}/editorial-policy`, lastModified: new Date(RELEASE_DATE), changeFrequency: 'monthly', priority: 0.7 },
