...
const pageDescription =
  `Salesforce Slack Administrator exam tips for ${RELEASE_CURRENT}: workspace management, channels, security, Slack Connect, and scenario strategy to pass first attempt.`
...
export default function SlackAdministratorExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/slack-administrator-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/slack-administrator-exam-tips' })
