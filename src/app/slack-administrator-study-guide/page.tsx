...
export default function SlackAdministratorStudyGuidePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/slack-administrator-study-guide" breadcrumbItems={breadcrumbItems} faqItems={faqItems} />
      <CredentialSchema
        certSlug="slack-administrator"
        certName="Slack Administrator"
        description={pageDescription}
        pageUrl="/slack-administrator-study-guide"
      />
      ...
      <ContentPageAuthor />
      <ExamTipsCrossLink examTipsSlug="slack-administrator-exam-tips" certName="Slack Administrator" />
      <CertInsightBlock certSlug="slack-administrator" />
      <ExamPricingCard
        certSlug="slack-administrator"
        certName="Slack Administrator"
      ...
      <DifficultyHeatmap slug="slack-administrator" />
