...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'Strategy Designer', url: '/certifications/strategy-designer' },
...
const faqItems = [
  ...
  ...getConceptFaqs('strategy-designer-exam-tips'),
]

export default function StrategyDesignerExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/strategy-designer-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/strategy-designer-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="strategy-designer-study-guide" certName="Strategy Designer" />
      <ExamPricingCard
        certSlug="strategy-designer"
        certName="Strategy Designer"
        certPageSlug="strategy-designer"
      />
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">Strategy + Design Methods + Facilitation = 75%. This exam rewards practitioners with real discovery and facilitation experience.</p>
        </div>
      </section>
