  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <CredentialSchema
        ...
        description={pageDescription}
        pageUrl="/strategy-designer-study-guide"
      />
      ...
      <ContentPageAuthor />
      <ExamTipsCrossLink examTipsSlug="strategy-designer-exam-tips" certName="Strategy Designer" />
      <CertInsightBlock certSlug="strategy-designer" />
      <ExamPricingCard
        certSlug="strategy-designer"
        certName="Strategy Designer"
