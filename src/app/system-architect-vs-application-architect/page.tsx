...
export default function SystemArchitectVsApplicationArchitectPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/system-architect-vs-application-architect', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/system-architect-vs-application-architect' })
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
        <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-xs font-semibold bg-salesforce-blue/10 text-salesforce-blue px-2 py-0.5 rounded-full">Start Here</span>
          </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100">
                ...
                <th className="text-left py-2 pr-4 text-gray-500 font-medium">Application Architect</th>
                <th className="text-left py-2 text-gray-500 font-medium">System Architect</th>
              </tr>
            </thead>
