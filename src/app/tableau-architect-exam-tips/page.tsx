...
const faqItems = [
  ...
  ...getConceptFaqs('tableau-architect-exam-tips'),
]
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">At a Glance: What Tableau Architect Covers</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">Architecture + Security + Performance = 77%. Enterprise topology design and RLS implementation are the highest-value study areas.</p>
        </div>
      </section>
