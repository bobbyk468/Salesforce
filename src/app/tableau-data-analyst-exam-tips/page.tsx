...
export const metadata: Metadata = {
  ...
  canonical: `${siteUrl}/certifications/tableau-data-analyst`,
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-gray-50 rounded-xl border border-gray-100 p-5 mb-8">
        ...
        <ul className="space-y-2">
          <li><Link href="/tableau-data-analyst-study-guide" className="text-sm text-salesforce-blue hover:underline font-medium">→ Tableau Data Analyst full study guide</Link></li>
        </ul>
      </div>
