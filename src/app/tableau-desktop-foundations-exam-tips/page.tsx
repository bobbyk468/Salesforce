...
const pageDescription =
  `Tableau Desktop Foundations exam tips for ${RELEASE_CURRENT}: data connections, basic charts, filters, and scenario strategy to pass this entry-level Tableau certification.`
...
export default function TableauDesktopFoundationsExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/tableau-desktop-foundations-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/tableau-desktop-foundations-exam-tips' })
