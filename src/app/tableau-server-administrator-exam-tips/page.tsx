...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${siteUrl}/certifications/tableau-server-administrator` },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    type: 'article',
...
export default function TableauServerAdministratorExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/tableau-server-administrator-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/tableau-server-administrator-exam-tips' })
