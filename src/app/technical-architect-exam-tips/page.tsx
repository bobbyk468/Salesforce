...
const breadcrumbItems = [
  { name: 'Home', url: '/' },
  { name: 'Technical Architect', url: '/certifications/technical-architect' },
...
export default function TechnicalArchitectExamTipsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ContentPageSchemas headline={pageTitle} description={pageDescription} path="/technical-architect-exam-tips" breadcrumbItems={breadcrumbItems} faqItems={faqItems}   mainEntityUrl="/technical-architect-study-guide"
      />
      ...
      <StudyGuideCrossLink studyGuideSlug="technical-architect-study-guide" certName="Technical Architect" />
      <ExamPricingCard
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">At a Glance: What the CTA Covers</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-600 pt-1">Most candidates spend 1–3 years preparing for the CTA after earning the Application and System Architect credentials. The Review Board pass rate is approximately 30–40% per attempt.</p>
        </div>
      </section>
