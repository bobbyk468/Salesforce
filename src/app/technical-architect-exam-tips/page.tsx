...
export const metadata: Metadata = {
  ...
  canonical: `${siteUrl}/certifications/technical-architect`,
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
...
export default function TechnicalArchitectExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/technical-architect-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/technical-architect-exam-tips' })
