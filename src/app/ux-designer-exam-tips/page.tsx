...
const pageDescription =
  `Salesforce UX Designer exam tips for ${RELEASE_CURRENT}: human-centred design, discovery, prototyping.`
...
export default function UxDesignerExamTipsPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/ux-designer-exam-tips', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/ux-designer-exam-tips' })
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-3">Quick Answer: What UX Designer Tests</h2>
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-6 mb-8">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p className="text-xs text-gray-500 pt-1">Human-Centred Design + Discovery = 44%. Know the design thinking phases and when to apply each research method.</p>
        </div>
      </section>
