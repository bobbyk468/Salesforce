...
export default function UxDesignerVsStrategyDesignerPage() {
  const webPageJsonLd = getWebPageJsonLd({ name: pageTitle, description: pageDescription, path: '/ux-designer-vs-strategy-designer', breadcrumbItems })
  const breadcrumbJsonLd = getBreadcrumbListJsonLd(breadcrumbItems)
  const articleJsonLd = getArticleJsonLd({ headline: pageTitle, description: pageDescription, path: '/ux-designer-vs-strategy-designer' })
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
        <div className="bg-white rounded-xl border-2 border-salesforce-blue p-6 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-xs font-semibold bg-salesforce-blue/10 text-salesforce-blue px-2 py-0.5 rounded-full">Take First (Designers)</span>
          </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100">
                ...
                <th className="text-left py-2 pr-4 text-gray-500 font-medium">UX Designer</th>
                <th className="text-left py-2 text-gray-500 font-medium">Strategy Designer</th>
              </tr>
            </thead>
