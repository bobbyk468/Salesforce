      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-gray-700 mt-8 pt-6">
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm">
            <Link href="/terms" className="text-gray-300 hover:text-salesforce-light transition-colors">
              Terms of Use
            </Link>
        ...
        <div className="border-t border-gray-700 mt-6 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-salesforce-light flex items-center space-x-1"
