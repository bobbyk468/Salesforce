...
export const OFFICIAL_CERT_NAMES: Record<string, string> = {
  ...
  // Consultant
  'crm-analytics-einstein-discovery-consultant': 'Salesforce Certified CRM Analytics and Einstein Discovery Consultant',
  ...
  'b2b-commerce-admin-ap': 'Salesforce Accredited B2B Commerce Administrator Professional',
  'b2b-commerce-developer-ap': 'Salesforce Accredited B2B Commerce Developer Professional',
