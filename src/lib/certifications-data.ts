...
const RAW_CERTIFICATION_CATEGORIES: CertificationCategory[] = [
  ...
  },
  {
    ...
    items: [
      { name: 'Business Analyst', href: '/certifications/business-analyst' },
      { name: 'CRM Analytics and Einstein Discovery', href: '/certifications/crm-analytics-einstein-discovery-consultant' },
      { name: 'Data 360 Consultant', href: '/certifications/data-360-consultant' },
      ...
      { name: 'Marketing Cloud Account Engagement Consultant', href: '/certifications/pardot-consultant' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Marketing Cloud Engagement Consultant', href: '/certifications/marketing-cloud-consultant' },
      { name: 'Marketing Cloud Engagement Developer', href: '/certifications/marketing-cloud-engagement-developer' },
      { name: 'Marketing Cloud Account Engagement Specialist', href: '/certifications/pardot-specialist' },
      { name: 'Marketing Cloud Account Engagement Consultant', href: '/certifications/pardot-consultant' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'B2B Commerce Administrator AP', href: '/certifications/b2b-commerce-admin-ap' },
      { name: 'B2B Commerce Developer AP', href: '/certifications/b2b-commerce-developer-ap' },
      { name: 'Agentforce Communications AP', href: '/certifications/communications-cloud-ap' },
      { name: 'Agentforce Consumer Goods AP', href: '/certifications/consumer-goods-cloud-ap' },
      ...
      { name: 'Agentforce Financial Services AP', href: '/certifications/financial-services-cloud-ap' },
      { name: 'Agentforce Health AP', href: '/certifications/health-cloud-ap' },
      ...
      { name: 'Agentforce Manufacturing AP', href: '/certifications/manufacturing-cloud-ap' },
      ...
      { name: 'Agentforce 360 Public Sector AP', href: '/certifications/public-sector-solutions-ap' },
    ],
  },
  {
    slug: 'sales',
    ...
    return overrideSlugs
      .map((slug) => {
        ...
        return {
          name: item.name,
          href: item.href,
          anchorText: `${item.name} Summer '26 prep guide`,
        }
      })
